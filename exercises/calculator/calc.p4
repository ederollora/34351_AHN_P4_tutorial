 ...
 *
 * To understand what & (AND), | (OR) and ^ (XOR) bitwise operators do, please
 * visit https://en.wikipedia.org/wiki/Bitwise_operation#Bitwise_operators
 *
...
const bit<8>  P4CALC_AND   = 0x26;   // '&', Bitwise operator AND
const bit<8>  P4CALC_OR    = 0x7c;   // '|', Bitwise operator OR
const bit<8>  P4CALC_CARET = 0x5e;   // '^', Bitwise operator XOR
